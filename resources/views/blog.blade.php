            ...
            <div class="flex flex-col lg:flex-row gap-12">
                ...
                <div class="w-full lg:w-2/3">
                    <div id="blog-posts" class="space-y-12">
                        <!-- Post 1 -->
                        <div class="blog-post bg-white dark:bg-gray-800/60 rounded-2xl shadow-lg overflow-hidden"
                             data-tags="fitness,gym">
                            ...
                            <div class="p-8">
                                <div class="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 mb-4">
                                    ...
                                    <span class="flex items-center gap-1"><x-heroicon-o-chat-bubble-left
                                            class="w-4 h-4"/> 3 Comments</span>
                                ...
                                <a href="#"
                                   class="inline-block text-red-500 font-bold hover:tracking-wide transition-all">READ
                                    MORE ></a>
                            </div>
                        </div>
                ...
                <div class="w-full lg:w-1/3 space-y-8">
                    <!-- Search -->
                    <div class="bg-white dark:bg-gray-800/60 p-6 rounded-2xl shadow-lg">
                    ...
                    <!-- Categories -->
                    <div class="bg-white dark:bg-gray-800/60 p-6 rounded-2xl shadow-lg">
                        <h4 class="text-xl font-bold text-gray-900 dark:text-white mb-6 border-b border-gray-200 dark:border-gray-700 pb-2">
                            Categories</h4>
                        <ul class="space-y-3">
                            <li><a href="#"
                                   class="text-gray-600 dark:text-gray-300 hover:text-red-500 transition flex justify-between"><span>Fitness</span>
                                    <span>(12)</span></a></li>
                            <li><a href="#"
                                   class="text-gray-600 dark:text-gray-300 hover:text-red-500 transition flex justify-between"><span>Yoga</span>
                                    <span>(5)</span></a></li>
                            <li><a href="#"
                                   class="text-gray-600 dark:text-gray-300 hover:text-red-500 transition flex justify-between"><span>Nutrition</span>
                                    <span>(8)</span></a></li>
                            <li><a href="#"
                                   class="text-gray-600 dark:text-gray-300 hover:text-red-500 transition flex justify-between"><span>Gym</span>
                                    <span>(10)</span></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800/60 p-6 rounded-2xl shadow-lg">
                        ...
                        <div class="flex flex-wrap gap-2" id="tag-cloud">
                            <button
                                class="tag-btn bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-4 py-2 rounded-lg text-sm hover:bg-red-500 hover:text-white transition"
                                data-tag="all">All
                            </button>
                            <button
                                class="tag-btn bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-4 py-2 rounded-lg text-sm hover:bg-red-500 hover:text-white transition"
                                data-tag="fitness">Fitness
                            </button>
                            <button
                                class="tag-btn bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 px-4 py-2 rounded-lg text-sm hover:bg-red-500 hover:text-white transition"
                                data-tag="yoga">Yoga
